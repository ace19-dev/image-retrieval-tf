...
flags.DEFINE_string('dataset_dir',
                    '/home/ace19/dl_data/modelnet10_s/view/classes',
                    'Root Directory to dataset.')
flags.DEFINE_string('output_path',
                    '/home/ace19/dl_data/modelnet10_s/validate.record',
...
def main(_):
    ...
    for i, cls in enumerate(dataset_lst):
        cls_path = os.path.join(FLAGS.dataset_dir, cls)
        filenames = sorted(os.listdir(os.path.join(cls_path, FLAGS.dataset_category)))
